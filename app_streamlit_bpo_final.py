...
def procesar_archivo(file):
    ...
    for agente in agentes_bpo:
        asignaciones.setdefault(agente, 0)
...
with col2:
    st.image("images/bpo_innovations_logo.jpg", width=120)
...
if uploaded_file:
    resultado = procesar_archivo(uploaded_file)
...
st.markdown("---")
st.markdown("Hecho con 💚 por el equipo de **BPO Innovations**")
